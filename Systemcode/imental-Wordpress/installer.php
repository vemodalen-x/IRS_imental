...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211028_imental_bc948b625a5820b89698_20211028072343_archive.zip';
	const ARCHIVE_SIZE		 = '59614519';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bc948b6-28072343';
    const SECONDARY_PACKAGE_HASH = '2a219bd-28072343';
	const VERSION			 = '1.4.3';
