...
#reference from paddleNLP interface  https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/dialogue/unified_transformer
def parse_args():
    """
    pass
    """
...
class PlatoNlp(object):
    ...
    pass
    """
    def __init__(self, max_turn=5,model="unified_transformer-12L-cn-luge"):
